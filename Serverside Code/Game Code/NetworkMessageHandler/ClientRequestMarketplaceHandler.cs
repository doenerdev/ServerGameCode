...
{
    class ClientRequestMarketplaceHandler : INetworkMessageHandler
    {
        public void HandleMessage(Player sender, Message message, ServiceContainer serviceContainer)
        {
            ...
            var marketplace = serviceContainer.DeckService.Marketplace;
            Message answer = Message.Create(NetworkMessageType.ServerSentMarketplace.ToString("G"));
