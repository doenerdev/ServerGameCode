...
{
    class ClientRequestDeckHandler : INetworkMessageHandler
    {
        public void HandleMessage(Player sender, Message message, ServiceContainer serviceContainer)
        {
            ...
            var deck = serviceContainer.DeckService.Deck;
            Message answer = Message.Create(NetworkMessageType.ServerSentDeck.ToString("G"));
